...
The full composition lives in `configs/example.yaml` (70 plugins, including the Phase 6A-7A.1 evaluation harness and twenty-four evaluator plugins). `AppConfig`
