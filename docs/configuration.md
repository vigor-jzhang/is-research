...
The full composition lives in `configs/example.yaml` (71 plugins, including the Phase 6A-7A.1 evaluation harness, twenty-four evaluator plugins, and the Phase 7B `evaluation.model_tournament` plugin). `AppConfig`
