...
Runs task-specific-model-qualification-v1 (10 cases) over the real
task-qualification algorithm; unsafe_task_qualification_rate must be 0.
Verifies rerun stability and provenance after reopen.
"""
